...
public class BackgroundWorkerR extends AsyncTask<String,Void,String> {
    ...
    String ltype;
    BackgroundWorkerR(Context ctx) {
        context = ctx;
    }
    @Override
    protected String doInBackground(String... params) {
        String type = params[0];
        String request_url = "http://chaitanya.freeoda.com/request.php";
    ...
    protected void onPreExecute() {
        ...
        alertDialog.setTitle("Organization Status");
    }
    ...
    protected void onPostExecute(String result) {
        ...
        if(ltype.equals("Error")) {
            Toast.makeText(context, "Not Entered due to Invalid data", Toast.LENGTH_LONG).show();
        }
        else {
